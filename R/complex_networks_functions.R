...
go_slim_annotation <- function(mylist){
  ...
  go_empty_mf <- data.frame(ID=character(43),Count=integer(43),Percent=integer(43),Term=character(43),Gene=character(43),DB=character(43),stringsAsFactors = FALSE); 
  go_empty_cc <- data.frame(ID=character(35),Count=integer(35),Percent=integer(35),Term=character(35),Gene=character(35),DB=character(35),stringsAsFactors = FALSE); 
  go_empty_bp <- data.frame(ID=character(71),Count=integer(71),Percent=integer(71),Term=character(71),Gene=character(71),DB=character(71),stringsAsFactors = FALSE); 
  ...
  for (i in 1:3){#length(names(gostuff))){
